const reservations = []; // Esto es solo un ejemplo. En una aplicación real, usarías una base de datos.

exports.createReservation = (req, res) => {
  const newReservation = req.body;
  newReservation.id = reservations.length + 1; // Generar un ID simple para este ejemplo
